...
function _createActorMethod(actor, methodName, func, blsVerify) {
    ...
    if (func.annotations.includes('query')) {
        ...
        caller = async (options, ...args) => {
            ...
            const responseBytes = await (0,_polling__WEBPACK_IMPORTED_MODULE_5__.pollForResponse)(agent, ecid, requestId, pollStrategy, blsVerify);
...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! .. */ "./node_modules/@dfinity/agent/lib/esm/index.js");
    ...
    const promises = uniquePaths.map((path, index) => {
        return (async () => {
            ...
            try {
                ...
                const cert = await ___WEBPACK_IMPORTED_MODULE_3__.Certificate.create({
...
const decodeHex = (buf) => {
    return (0,___WEBPACK_IMPORTED_MODULE_3__.toHex)(buf);
};
...
const decodeCbor = (buf) => {
    return ___WEBPACK_IMPORTED_MODULE_3__.Cbor.decode(buf);
};
...
async function fetchCandid(canisterId, agent) {
    if (!agent) {
        ...
        agent = new ___WEBPACK_IMPORTED_MODULE_0__.HttpAgent();
        if (agent.isLocal()) {
            agent.fetchRootKey();
        }
    }
    // Attempt to use canister metadata
    const status = await ___WEBPACK_IMPORTED_MODULE_0__.CanisterStatus.request({
        agent,
        canisterId: _dfinity_principal__WEBPACK_IMPORTED_MODULE_1__.Principal.fromText(canisterId),
        paths: ['candid'],
    });
    ...
    const actor = ___WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(tmpHackInterface, { agent, canisterId });
...
/* harmony export */   "blsVerify": () => (/* reexport safe */ _utils_bls__WEBPACK_IMPORTED_MODULE_10__.blsVerify),
/* harmony export */   "compare": () => (/* reexport safe */ _utils_buffer__WEBPACK_IMPORTED_MODULE_11__.compare),
/* harmony export */   "concat": () => (/* reexport safe */ _utils_buffer__WEBPACK_IMPORTED_MODULE_11__.concat),
...
/* harmony export */   "fromHex": () => (/* reexport safe */ _utils_buffer__WEBPACK_IMPORTED_MODULE_11__.fromHex),
...
/* harmony export */   "hash": () => (/* reexport safe */ _request_id__WEBPACK_IMPORTED_MODULE_9__.hash),
/* harmony export */   "hashTreeToString": () => (/* reexport safe */ _certificate__WEBPACK_IMPORTED_MODULE_3__.hashTreeToString),
/* harmony export */   "hashValue": () => (/* reexport safe */ _request_id__WEBPACK_IMPORTED_MODULE_9__.hashValue),
...
/* harmony export */   "requestIdOf": () => (/* reexport safe */ _request_id__WEBPACK_IMPORTED_MODULE_9__.requestIdOf),
/* harmony export */   "toHex": () => (/* reexport safe */ _utils_buffer__WEBPACK_IMPORTED_MODULE_11__.toHex),
/* harmony export */   "verify": () => (/* reexport safe */ _utils_bls__WEBPACK_IMPORTED_MODULE_10__.verify)
/* harmony export */ });
/* harmony import */ var _actor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actor */ "./node_modules/@dfinity/agent/lib/esm/actor.js");
/* harmony import */ var _agent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./agent */ "./node_modules/@dfinity/agent/lib/esm/agent/index.js");
/* harmony import */ var _auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./auth */ "./node_modules/@dfinity/agent/lib/esm/auth.js");
...
/* harmony import */ var _request_id__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./request_id */ "./node_modules/@dfinity/agent/lib/esm/request_id.js");
/* harmony import */ var _utils_bls__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils/bls */ "./node_modules/@dfinity/agent/lib/esm/utils/bls.js");
/* harmony import */ var _utils_buffer__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./utils/buffer */ "./node_modules/@dfinity/agent/lib/esm/utils/buffer.js");
...
/***/ "./src/declarations/dbank_backend/dbank_backend.did.js":
/*!*************************************************************!*\
  !*** ./src/declarations/dbank_backend/dbank_backend.did.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/declarations/dbank_backend/index.js":
/*!*************************************************!*\
  !*** ./src/declarations/dbank_backend/index.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "dbank_backend": () => (/* binding */ dbank_backend),
/* harmony export */   "idlFactory": () => (/* reexport safe */ _dbank_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory)
/* harmony export */ });
...
/* harmony import */ var _dbank_backend_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dbank_backend.did.js */ "./src/declarations/dbank_backend/dbank_backend.did.js");
/* provided dependency */ var process = __webpack_require__(/*! ./node_modules/process/browser.js */ "./node_modules/process/browser.js");
...
const createActor = (canisterId, options = {}) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_dbank_backend_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
const dbank_backend = createActor(canisterId);
...
"use strict";
/*!*****************************************!*\
  !*** ./src/dbank_frontend/src/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/dbank_backend */ "./src/declarations/dbank_backend/index.js");


window.addEventListener("load", async function(){
  //console.log("Finished Loading");
  const currentAmount = await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.checkBalance();
...
document.querySelector("form").addEventListener("submit", async function(event){
  ...
  if (document.getElementById("input-amount").value.length != 0) {
    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.topUp(inputAmount);
  }

  if (document.getElementById("withdrawal-amount").value.length !=0){
    await _declarations_dbank_backend__WEBPACK_IMPORTED_MODULE_0__.dbank_backend.withdrawl(outputAmount);
  }
  ...
  document.getElementById("withdrawal-amout").value = "";
